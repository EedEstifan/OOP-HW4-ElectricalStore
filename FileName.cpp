...
//		auto start =
//			std::chrono::time_point_cast<std::chrono::microseconds>(start_point).time_since_epoch().count();
//		auto end =
//
...
//	}
//
//	double avg = (time_counter_sum - max_count) * (1 / double(TEST_COUNT -
//		1));
...
//
//template <int i>
//PeripheralDerived<i>::PeripheralDerived(int price, const std::string& manufacturer, const std::string& color, bool isWireless) : Item(price, manufacturer), PeripheralDevice(0, "0", color, isWireless) {}
//template <int i>
